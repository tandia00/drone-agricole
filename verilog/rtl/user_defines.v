...
// GPIO 5-7 : Non utilisees par le drone (entree securisee)
...
// GPIO 8-15 : Capteur altitude (8 bits, entree)
...
// GPIO 14-15 : Suite capteur altitude
...
// GPIO 16-23 : Capteur niveau cuve (8 bits, entree)
...
// GPIO 26 : Sortie commande valve (relais)
`define USER_CONFIG_GPIO_26_INIT `GPIO_MODE_USER_STD_OUTPUT

// GPIO 27 : Sortie PWM pompe (MOSFET driver)
`define USER_CONFIG_GPIO_27_INIT `GPIO_MODE_USER_STD_OUTPUT

// GPIO 28-37 : Non utilisees par le drone (entree securisee)
